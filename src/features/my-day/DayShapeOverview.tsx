...
export function DayShapeOverview({ model, periods, nowMinute, onOpen }: { model: ModelResult; periods: DerivedPeriod[]; nowMinute: number; onOpen: () => void }) {
  const width = 330, height = 76, left = 10, right = 10, top = 24, bottom = 15;
  ...
  return <button className="day-overview" onClick={onOpen} aria-label={`Modeled day overview. Now at ${minuteToTime(normalizedNow)}. Open full day overview.`} data-testid="day-overview">
